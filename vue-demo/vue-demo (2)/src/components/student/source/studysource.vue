...
<!--          <el-button type="text" size="mini" @click="downloadClick(scope.$index,scope.row)" id="downloadbutton" icon="el-icon-download">下载</el-button>-->
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
  ...
  methods: {
    ...
    queryView(pageNum) {
      ...
      this.$axios({
        ...
        url: 'http://1.15.149.222:8080/coursewebsite/student/resource/all?clazzId=' + this.cId +'&pn='+pageNum,
      }).then((response) => {
