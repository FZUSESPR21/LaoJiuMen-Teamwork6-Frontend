        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-popover
              ...
              <el-button slot="reference" v-if="scope.row.type=='2'" type="text" size="mini" @click="editClick" class="button" icon="el-icon-edit">编辑</el-button>
              <el-button slot="reference" v-else type="text" size="mini" class="button" icon="el-icon-download">下载</el-button>
            </el-popover>
<!--            <el-button v-if="scope.row.type=='2'" type="text" size="mini" @click="editClick" class="button" icon="el-icon-edit">编辑</el-button>
            <el-button v-else type="text" size="mini" @click="downloadClick(scope.$index,scope.row)" class="button" icon="el-icon-download">下载</el-button>-->
            <el-popover
              placement="top"
              width="160"
              v-model="visible"
